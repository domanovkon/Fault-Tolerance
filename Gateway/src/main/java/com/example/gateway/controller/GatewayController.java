...
public class GatewayController {
    ...
    @CrossOrigin(origins = "*")
    public ResponseEntity<Object> getBonusAccountPrivileges(@RequestHeader("X-User-Name") String username) throws IOException, InterruptedException {
    ...
    @PostMapping("/tickets")
    @CrossOrigin(origins = "*")
    public ResponseEntity<Object> buyTicket(@RequestHeader("X-User-Name") String username, @RequestBody FlightBuyRequest flightBuyRequest) throws IOException, InterruptedException {
    ...
    @GetMapping("/me")
    @CrossOrigin(origins = "*")
    public Object getUser(@RequestHeader("X-User-Name") String username) throws IOException, InterruptedException {
        return gatewayService.getUser(username);
    }

    @DeleteMapping("tickets/{ticketUid}")
    @CrossOrigin(origins = "*")
    public ResponseEntity<Object> ticketCancel(@PathVariable(value = "ticketUid") UUID ticketUid, @RequestHeader("X-User-Name") String username) throws IOException, InterruptedException {
